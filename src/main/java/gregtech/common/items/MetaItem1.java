...
public class MetaItem1 extends MaterialMetaItem {
    ...
    public void registerSubItems() {
        ...
        GEAR_ASSEMBLY_LV = addItem(2746, "electric.motor.lv");
        GEAR_ASSEMBLY_MV = addItem(2747, "electric.motor.mv");
        GEAR_ASSEMBLY_HV = addItem(2748, "electric.motor.hv");
        GEAR_ASSEMBLY_EV = addItem(2749, "electric.motor.ev");
        GEAR_ASSEMBLY_IV = addItem(2750, "electric.motor.iv");
        GEAR_ASSEMBLY_LUV = addItem(2751, "electric.motor.luv");
        GEAR_ASSEMBLY_ZPM = addItem(2752, "electric.motor.zpm");
        GEAR_ASSEMBLY_UV = addItem(2753, "electric.motor.uv");
